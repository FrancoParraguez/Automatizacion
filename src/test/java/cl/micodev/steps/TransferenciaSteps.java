...
public class TransferenciaSteps {
    ...
    public void hacer_click_en_el_link_transfer_funds(String enlace) throws InterruptedException {
        Thread.sleep(2000);
        driver.findElement(By.xpath(enlace)).click();
    }

    @When("hacer click en el boton Transfer Money {string}")
    public void hacer_click_en_el_boton_transfer_money(String boton) throws InterruptedException {
        Thread.sleep(2000);
        driver.findElement(By.xpath(boton)).click();
    }
